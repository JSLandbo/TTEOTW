...
namespace ModelLibrary.Concrete.Blocks
{
    ...
    {
        [JsonConstructor]
        public BlockInfo(long MinimumDepth = long.MinValue, long MaximumDepth = long.MaxValue, Vector2 OccurrenceSpan = new Vector2(), float Weight = 0.0f, float MiningHeatGeneration = 0.1f)
        {

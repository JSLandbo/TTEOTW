...
namespace ModelLibrary.Concrete.Items
{
    public sealed class NukeDynamite : ADynamite
    {
        ...
        [JsonConstructor]
        public NukeDynamite(short ID, string Name, int ExplosionAreaSize, int ExplosionPlaybackFrames, float Damage, float MaxHardness, float Worth = 0.0f, float Weight = 0.0f, ExplosionType ExplosionType = ExplosionType.Dynamite, bool Stackable = true)
        {
            this.ID = ID;
            this.Name = Name;

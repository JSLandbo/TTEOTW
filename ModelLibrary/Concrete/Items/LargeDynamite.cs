...
namespace ModelLibrary.Concrete.Items
{
    public sealed class LargeDynamite : ADynamite
    {
        ...
        [JsonConstructor]
        public LargeDynamite(short ID, string Name, int ExplosionAreaSize, int ExplosionPlaybackFrames, float Damage, float MaxHardness, float Worth = 0.0f, float Weight = 0.0f, bool Stackable = true)
        {
            this.ID = ID;
            this.Name = Name;

...
namespace ToTheEndOfTheWorld.Context
{
    public class WorldElementsRepository : Dictionary<int, (string Name, Texture2D Texture, int Frames, Block block)>
    {
        ...
        private void InitializeCollection(ContentManager manager)
        {
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Mythril, "Mythril", "Blocks/MythrilBlock", hardness: 500, health: 2500, minimumDepth: 6000, maximumDepth: 800000, occurrenceSpan: new Vector2(10.25f, 10.50f), worth: 500, weight: 1.0f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.RainbowGem, "Rainbow gem", "Blocks/RainbowGemBlock", hardness: 2200, health: 12000, minimumDepth: 18000, maximumDepth: long.MaxValue, occurrenceSpan: new Vector2(14.83f, 14.93f), worth: 200, weight: 1.0f);

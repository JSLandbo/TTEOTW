...
namespace ToTheEndOfTheWorld.Context
{
    public class WorldElementsRepository : Dictionary<int, (string Name, Texture2D Texture, int Frames, Block block)>
    {
        ...
        private void InitializeCollection(ContentManager manager)
        {
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Tin, "Tin ore", "Blocks/TinBlock", hardness: 4, health: 35, minimumDepth: 80, maximumDepth: 2200, occurrenceSpan: new Vector2(9f, 9.5f), worth: 4, weight: 1.2f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Iron, "Iron ore", "Blocks/IronBlock", hardness: 10, health: 80, minimumDepth: 220, maximumDepth: 5200, occurrenceSpan: new Vector2(5f, 6f), worth: 5, weight: 1.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Lava, "Lava", "Blocks/LavaBlock", hardness: 20, health: 100, minimumDepth: 5000, maximumDepth: 250000, occurrenceSpan: new Vector2(13.43f, 13.53f), worth: 5, miningHeatGeneration: 20f, weight: 1.1f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Copper, "Copper ore", "Blocks/CopperBlock", hardness: 5, health: 60, minimumDepth: 140, maximumDepth: 3600, occurrenceSpan: new Vector2(8f, 8.5f), worth: 10, weight: 1.6f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Gold, "Gold ore", "Blocks/GoldBlock", hardness: 35, health: 260, minimumDepth: 3200, maximumDepth: 18000, occurrenceSpan: new Vector2(10f, 10.25f), worth: 50, weight: 2.0f);
            AddTexturedBlock(manager, GameIds.Blocks.Alexandrite, "Alexandrite", "Blocks/AlexandriteBlock", hardness: 38, health: 250, minimumDepth: 4000, maximumDepth: 22000, occurrenceSpan: new Vector2(10.625f, 10.80f), worth: 35, weight: 0.7f);
            AddTexturedBlock(manager, GameIds.Blocks.Chromium, "Chromium", "Blocks/ChromiumBlock", hardness: 55, health: 360, minimumDepth: 5000, maximumDepth: 26000, occurrenceSpan: new Vector2(12.12f, 12.28f), worth: 35, weight: 2.0f);
            AddTexturedBlock(manager, GameIds.Blocks.Amethyst, "Amethyst", "Blocks/AmethystBlock", hardness: 45, health: 280, minimumDepth: 5200, maximumDepth: 24000, occurrenceSpan: new Vector2(10.95f, 11.10f), worth: 38, weight: 0.7f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Cobalt, "Cobalt", "Blocks/CobaltBlock", hardness: 60, health: 380, minimumDepth: 5200, maximumDepth: 28000, occurrenceSpan: new Vector2(12.43f, 12.58f), worth: 42, weight: 1.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Topaz, "Topaz", "Blocks/TopazBlock", hardness: 70, health: 430, minimumDepth: 6500, maximumDepth: 30000, occurrenceSpan: new Vector2(15.82f, 15.97f), worth: 45, weight: 0.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Emerald, "Emerald", "Blocks/EmeraldBlock", hardness: 65, health: 400, minimumDepth: 7000, maximumDepth: 28000, occurrenceSpan: new Vector2(12.98f, 13.13f), worth: 50, weight: 0.7f);
            AddTexturedBlock(manager, GameIds.Blocks.Ruby, "Ruby", "Blocks/RubyBlock", hardness: 75, health: 460, minimumDepth: 7250, maximumDepth: 32000, occurrenceSpan: new Vector2(15.00f, 15.15f), worth: 60, weight: 0.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Sapphire, "Sapphire", "Blocks/SapphireBlock", hardness: 78, health: 480, minimumDepth: 7500, maximumDepth: 34000, occurrenceSpan: new Vector2(15.15f, 15.30f), worth: 60, weight: 0.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Diode, "Diode", "Blocks/DiodeBlock", hardness: 110, health: 600, minimumDepth: 10000, maximumDepth: 45000, occurrenceSpan: new Vector2(12.88f, 12.98f), worth: 70, weight: 0.6f);
            AddTexturedBlock(manager, GameIds.Blocks.Osmium, "Osmium", "Blocks/OsmiumBlock", hardness: 180, health: 1200, minimumDepth: 16000, maximumDepth: 50000, occurrenceSpan: new Vector2(13.98f, 14.13f), worth: 70, weight: 2.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Tungsten, "Tungsten", "Blocks/TungstenBlock", hardness: 360, health: 2400, minimumDepth: 32000, maximumDepth: 76000, occurrenceSpan: new Vector2(16.05f, 16.20f), worth: 80, weight: 3.0f);
            AddTexturedBlock(manager, GameIds.Blocks.Platinum, "Platinum", "Blocks/PlatinumBlock", hardness: 280, health: 1800, minimumDepth: 24000, maximumDepth: 62000, occurrenceSpan: new Vector2(14.28f, 14.43f), worth: 90, weight: 2.4f);
            AddTexturedBlock(manager, GameIds.Blocks.Diamond, "Diamond", "Blocks/DiamondBlock", hardness: 170, health: 1100, minimumDepth: 12000, maximumDepth: 50000, occurrenceSpan: new Vector2(12.73f, 12.88f), worth: 100, weight: 0.6f);
            AddTexturedBlock(manager, GameIds.Blocks.Titanium, "Titanium", "Blocks/TitaniumBlock", hardness: 320, health: 2100, minimumDepth: 28000, maximumDepth: 70000, occurrenceSpan: new Vector2(15.67f, 15.82f), worth: 110, weight: 2.6f);
            AddTexturedBlock(manager, GameIds.Blocks.Obsidian, "Obsidian", "Blocks/ObsidianBlock", hardness: 220, health: 1500, minimumDepth: 18000, maximumDepth: 52000, occurrenceSpan: new Vector2(13.68f, 13.83f), worth: 120, weight: 2.4f);
            AddTexturedBlock(manager, GameIds.Blocks.Rainbow, "Rainbow", "Blocks/RainbowBlock", hardness: 850, health: 5000, minimumDepth: 50000, maximumDepth: 110000, occurrenceSpan: new Vector2(16.55f, 16.63f), worth: 125, weight: 0.7f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Uranium, "Uranium", "Blocks/UraniumBlock", hardness: 380, health: 2800, minimumDepth: 34000, maximumDepth: 82000, occurrenceSpan: new Vector2(16.20f, 16.35f), worth: 175, weight: 2.2f);
            AddTexturedBlock(manager, GameIds.Blocks.Mythril, "Mythril", "Blocks/MythrilBlock", hardness: 1800, health: 9000, minimumDepth: 68000, maximumDepth: 130000, occurrenceSpan: new Vector2(10.25f, 10.50f), worth: 250, weight: 1.0f);
            AddTexturedBlock(manager, GameIds.Blocks.Adamantium, "Adamantium", "Blocks/AdamantiumBlock", hardness: 3500, health: 15000, minimumDepth: 88000, maximumDepth: 160000, occurrenceSpan: new Vector2(10.50f, 10.625f), worth: 500, weight: 1.3f);

...
namespace ToTheEndOfTheWorld.Context
{
    public class WorldElementsRepository : Dictionary<int, (string Name, Texture2D Texture, Block block)>
    {
        ...
        private void InitializeCollection(ContentManager manager)
        {
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Tungsten, "Tungsten", "Blocks/TungstenBlock", hardness: 300, health: 1100, minimumDepth: 7000, maximumDepth: 800000, occurrenceSpan: new Vector2(16.05f, 16.20f), worth: 260, weight: 1.0f);

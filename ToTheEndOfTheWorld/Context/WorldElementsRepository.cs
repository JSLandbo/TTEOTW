...
namespace ToTheEndOfTheWorld.Context
{
    public class WorldElementsRepository : Dictionary<int, (string Name, Texture2D Texture, int Frames, Block block)>
    {
        ...
        private void InitializeCollection(ContentManager manager)
        {
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Amethyst, "Amethyst", "Blocks/AmethystBlock", hardness: 40, health: 280, minimumDepth: 5500, maximumDepth: 36000, occurrenceSpan: new Vector2(10.95f, 11.10f), worth: 38, weight: 0.7f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Topaz, "Topaz", "Blocks/TopazBlock", hardness: 70, health: 430, minimumDepth: 7500, maximumDepth: 45000, occurrenceSpan: new Vector2(15.82f, 15.97f), worth: 45, weight: 0.8f);
            AddTexturedBlock(manager, GameIds.Blocks.Emerald, "Emerald", "Blocks/EmeraldBlock", hardness: 65, health: 400, minimumDepth: 8000, maximumDepth: 42000, occurrenceSpan: new Vector2(12.98f, 13.13f), worth: 50, weight: 0.7f);
            AddTexturedBlock(manager, GameIds.Blocks.Ruby, "Ruby", "Blocks/RubyBlock", hardness: 75, health: 460, minimumDepth: 8250, maximumDepth: 48000, occurrenceSpan: new Vector2(15.00f, 15.15f), worth: 60, weight: 0.8f);

...
namespace ToTheEndOfTheWorld.Context
{
    public class WorldElementsRepository : Dictionary<int, (string Name, Texture2D Texture, int Frames, Block block)>
    {
        ...
        private void InitializeCollection(ContentManager manager)
        {
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Dirt, "Dirt", "Blocks/DirtBlock", hardness: 0, health: 12, minimumDepth: 12, maximumDepth: long.MaxValue, occurrenceSpan: new Vector2(0f, 100f), worth: 1, weight: 1.0f);
            ...
            AddTexturedBlock(manager, GameIds.Blocks.Rock, "Rock", "Blocks/StoneBlock", hardness: 20, health: 50, minimumDepth: 12, maximumDepth: long.MaxValue, occurrenceSpan: new Vector2(2f, 4f), worth: 2, weight: 2.3f);

...
namespace ToTheEndOfTheWorld.Context
{
    public class WorldElementsRepository : Dictionary<int, (string Name, Texture2D Texture, Block block)>
    {
        ...
        private void InitializeCollection(ContentManager manager)
        {
            ...
            var GraniteBlock = new Block(ID: 5, Ethereal: false, Hardness: 50, Health: 100, Worth: 4, Info: GraniteBlockInfo);
            ...
            var IronBlock = new Block(ID: 6, Ethereal: false, Hardness: 15, Health: 75, Worth: 5, Info: IronBlockInfo);
            ...
            var LeadBlock = new Block(ID: 7, Ethereal: false, Hardness: 5, Health: 50, Worth: 7, Info: LeadBlockInfo);
            ...
            var AluminumBlock = new Block(ID: 8, Ethereal: false, Hardness: 15, Health: 100, Worth: 10, Info: AluminumBlockInfo);
            ...
            var ZincBlock = new Block(ID: 9, Ethereal: false, Hardness: 20, Health: 150, Worth: 14, Info: ZincBlockInfo);
            ...
            var CopperBlock = new Block(ID: 10, Ethereal: false, Hardness: 25, Health: 200, Worth: 20, Info: CopperBlockInfo);
            ...
            var NickelBlock = new Block(ID: 11, Ethereal: false, Hardness: 35, Health: 300, Worth: 30, Info: NickelBlockInfo);
            ...
            var TinBlock = new Block(ID: 12, Ethereal: false, Hardness: 10, Health: 50, Worth: 45, Info: TinBlockInfo);
            ...
            var SilverBlock = new Block(ID: 13, Ethereal: false, Hardness: 20, Health: 85, Worth: 80, Info: SilverBlockInfo);
            ...
            var GoldBlock = new Block(ID: 14, Ethereal: false, Hardness: 20, Health: 250, Worth: 160, Info: GoldBlockInfo);
            ...
            var MythrilBlock = new Block(ID: 15, Ethereal: false, Hardness: 500, Health: 2500, Worth: 2500, Info: MythrilBlockInfo);
            ...
            var AdamantBlock = new Block(ID: 16, Ethereal: false, Hardness: 1500, Health: 8500, Worth: 18000, Info: AdamantBlockInfo);

...
namespace ToTheEndOfTheWorld.Context
{
    public sealed partial class GameItemsRepository
    {
        ...
        private void RegisterEngines(ContentManager manager)
        {
            ...
            AddDefinition(10105, "DiamondEngine", LoadSingleTexture(manager, "Graphics/Player/Engines/ScrapEngine/ScrapEngine"), new Engine(ID: 10105, Speed: 80, Name: "Diamond Engine", ActiveFuelConsumption: 0.46f, Worth: 15000, Weight: 7), equipmentShopOrder: 51);
            AddDefinition(10106, "RadioactiveEngine", LoadSingleTexture(manager, "Graphics/Player/Engines/ScrapEngine/ScrapEngine"), new Engine(ID: 10106, Speed: 160, Name: "Radioactive Engine", ActiveFuelConsumption: 0.34f, Worth: 50000, Weight: 6), equipmentShopOrder: 61);
        ...
        {
            AddDefinition(10300, "ScrapContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10300, Items: CreateInventoryGrid(1, 1), SizeLimit: 64, Name: "Scrap Container", Worth: 5, Weight: 5, MaxStackSize: 64), equipmentShopOrder: 4);
            AddDefinition(10301, "CopperContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10301, Items: CreateInventoryGrid(1, 3), SizeLimit: 192, Name: "Copper Container", Worth: 100, Weight: 6, MaxStackSize: 64), equipmentShopOrder: 14);
            AddDefinition(10302, "IronContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10302, Items: CreateInventoryGrid(2, 3), SizeLimit: 384, Name: "Iron Container", Worth: 400, Weight: 7, MaxStackSize: 64), equipmentShopOrder: 24);
            AddDefinition(10303, "GoldContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10303, Items: CreateInventoryGrid(3, 3), SizeLimit: 576, Name: "Gold Container", Worth: 1500, Weight: 8, MaxStackSize: 64), equipmentShopOrder: 34);
            AddDefinition(10304, "CrystalContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10304, Items: CreateInventoryGrid(3, 4), SizeLimit: 768, Name: "Crystal Container", Worth: 5000, Weight: 8, MaxStackSize: 64), equipmentShopOrder: 44);
            AddDefinition(10305, "DiamondContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10305, Items: CreateInventoryGrid(4, 4), SizeLimit: 1024, Name: "Diamond Container", Worth: 15000, Weight: 7, MaxStackSize: 64), equipmentShopOrder: 54);
            AddDefinition(10306, "RadioactiveContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10306, Items: CreateInventoryGrid(4, 5), SizeLimit: 1280, Name: "Radioactive Container", Worth: 50000, Weight: 6, MaxStackSize: 64), equipmentShopOrder: 64);
            AddDefinition(10307, "RainbowContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10307, Items: CreateInventoryGrid(5, 5), SizeLimit: 1600, Name: "Rainbow Container", Worth: 150000, Weight: 5, MaxStackSize: 64), equipmentShopOrder: 74);
            AddDefinition(10308, "MythrilContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10308, Items: CreateInventoryGrid(8, 6), SizeLimit: 6144, Name: "Mythril Container", Worth: 500000, Weight: 4, MaxStackSize: 128), equipmentShopOrder: 84);
            AddDefinition(10309, "AdamantContainer", LoadSingleTexture(manager, "Graphics/Player/FuelTanks/ScrapFuelTank/ScrapFuelTank"), new Inventory(ID: 10309, Items: CreateInventoryGrid(18, 8), SizeLimit: 73728, Name: "Adamant Container", Worth: 1500000, Weight: 4, MaxStackSize: 512), equipmentShopOrder: 94);
        }

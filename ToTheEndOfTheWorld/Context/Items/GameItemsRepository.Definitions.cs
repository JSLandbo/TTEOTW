...
namespace ToTheEndOfTheWorld.Context
{
    public sealed partial class GameItemsRepository
    {
        ...
        {
            AddDefinition(10400, "ScrapThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10400, Speed: 240f, Acceleration: 30f, Power: 50, Name: "Scrap Thruster", ActiveFuelConsumption: 2.0f, Weight: 5, Worth: ScrapTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 3);
            AddDefinition(10401, "CopperThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10401, Speed: 480f, Acceleration: 60f, Power: 75, Name: "Copper Thruster", ActiveFuelConsumption: 2.2f, Weight: 6, Worth: CopperTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 13);
            AddDefinition(10402, "IronThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10402, Speed: 960f, Acceleration: 120f, Power: 110, Name: "Iron Thruster", ActiveFuelConsumption: 2.5f, Weight: 7, Worth: IronTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 23);
            AddDefinition(10403, "GoldThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10403, Speed: 1920f, Acceleration: 240f, Power: 160, Name: "Gold Thruster", ActiveFuelConsumption: 2.9f, Weight: 8, Worth: GoldTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 33);
            AddDefinition(10404, "CrystalThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10404, Speed: 3840f, Acceleration: 480f, Power: 230, Name: "Crystal Thruster", ActiveFuelConsumption: 3.4f, Weight: 8, Worth: CrystalTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 43);
            AddDefinition(10405, "DiamondThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10405, Speed: 7680f, Acceleration: 960f, Power: 320, Name: "Diamond Thruster", ActiveFuelConsumption: 4.0f, Weight: 7, Worth: DiamondTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 53);
            AddDefinition(10406, "RadioactiveThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10406, Speed: 15360f, Acceleration: 1920f, Power: 440, Name: "Radioactive Thruster", ActiveFuelConsumption: 4.7f, Weight: 6, Worth: RadioactiveTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 63);
            AddDefinition(10407, "RainbowThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10407, Speed: 30720f, Acceleration: 3840f, Power: 1500, Name: "Rainbow Thruster", ActiveFuelConsumption: 5.5f, Weight: 5, Worth: RainbowTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 73);
            AddDefinition(10408, "MythrilThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10408, Speed: 61440f, Acceleration: 7680f, Power: 2200, Name: "Mythril Thruster", ActiveFuelConsumption: 6.2f, Weight: 4, Worth: MythrilTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 83);
            AddDefinition(10409, "AdamantThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: 10409, Speed: 122880f, Acceleration: 15360f, Power: 3200, Name: "Adamant Thruster", ActiveFuelConsumption: 7.0f, Weight: 4, Worth: AdamantTierWorth, MinimumVelocity: 10f), equipmentShopOrder: 93);
        }

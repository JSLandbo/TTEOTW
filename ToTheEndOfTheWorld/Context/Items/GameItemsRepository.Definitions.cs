...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Thrusters.Scrap, "ScrapThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: GameIds.Items.Thrusters.Scrap, Speed: 500f, Acceleration: 50f, Power: 50, Name: "Scrap Thruster", ActiveFuelConsumption: 0.01f, ActiveHeatGeneration: 0.10f, Weight: 5, Worth: ScrapTierWorth), EEquipmentType.Thruster, 0);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Copper, "CopperThruster", LoadSingleTexture(manager, "Player/Thrusters/CopperThruster"), new Thruster(ID: GameIds.Items.Thrusters.Copper, Speed: 1100f, Acceleration: 100f, Power: 75, Name: "Copper Thruster", ActiveFuelConsumption: 0.3f, ActiveHeatGeneration: 0.18f, Weight: 6, Worth: CopperTierWorth), EEquipmentType.Thruster, 1);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Iron, "IronThruster", LoadSingleTexture(manager, "Player/Thrusters/IronThruster"), new Thruster(ID: GameIds.Items.Thrusters.Iron, Speed: 2000f, Acceleration: 200f, Power: 110, Name: "Iron Thruster", ActiveFuelConsumption: 2.0f, ActiveHeatGeneration: 0.28f, Weight: 7, Worth: IronTierWorth), EEquipmentType.Thruster, 2);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Gold, "GoldThruster", LoadSingleTexture(manager, "Player/Thrusters/GoldThruster"), new Thruster(ID: GameIds.Items.Thrusters.Gold, Speed: 4000f, Acceleration: 300f, Power: 160, Name: "Gold Thruster", ActiveFuelConsumption: 2.9f, ActiveHeatGeneration: 0.40f, Weight: 8, Worth: GoldTierWorth), EEquipmentType.Thruster, 3);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Crystal, "CrystalThruster", LoadSingleTexture(manager, "Player/Thrusters/CrystalThruster"), new Thruster(ID: GameIds.Items.Thrusters.Crystal, Speed: 8000f, Acceleration: 400f, Power: 230, Name: "Crystal Thruster", ActiveFuelConsumption: 3.4f, ActiveHeatGeneration: 0.55f, Weight: 8, Worth: CrystalTierWorth), EEquipmentType.Thruster, 4);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Diamond, "DiamondThruster", LoadSingleTexture(manager, "Player/Thrusters/DiamondThruster"), new Thruster(ID: GameIds.Items.Thrusters.Diamond, Speed: 24000f, Acceleration: 800f, Power: 320, Name: "Diamond Thruster", ActiveFuelConsumption: 4.0f, ActiveHeatGeneration: 0.75f, Weight: 7, Worth: DiamondTierWorth), EEquipmentType.Thruster, 5);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Radioactive, "RadioactiveThruster", LoadSingleTexture(manager, "Player/Thrusters/RadioactiveThruster"), new Thruster(ID: GameIds.Items.Thrusters.Radioactive, Speed: 15360f, Acceleration: 1200f, Power: 440, Name: "Radioactive Thruster", ActiveFuelConsumption: 4.7f, ActiveHeatGeneration: 1.00f, Weight: 6, Worth: RadioactiveTierWorth), EEquipmentType.Thruster, 6);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Rainbow, "RainbowThruster", LoadSingleTexture(manager, "Player/Thrusters/RainbowThruster"), new Thruster(ID: GameIds.Items.Thrusters.Rainbow, Speed: 48000f, Acceleration: 2000f, Power: 1500, Name: "Rainbow Thruster", ActiveFuelConsumption: 5.5f, ActiveHeatGeneration: 1.35f, Weight: 5, Worth: RainbowTierWorth), EEquipmentType.Thruster, 7);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Mythril, "MythrilThruster", LoadSingleTexture(manager, "Player/Thrusters/MythrilThruster"), new Thruster(ID: GameIds.Items.Thrusters.Mythril, Speed: 96000f, Acceleration: 3000f, Power: 2200, Name: "Mythril Thruster", ActiveFuelConsumption: 6.2f, ActiveHeatGeneration: 1.75f, Weight: 4, Worth: MythrilTierWorth), EEquipmentType.Thruster, 8);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Adamant, "AdamantThruster", LoadSingleTexture(manager, "Player/Thrusters/AdamantThruster"), new Thruster(ID: GameIds.Items.Thrusters.Adamant, Speed: 192000f, Acceleration: 4000f, Power: 3200, Name: "Adamant Thruster", ActiveFuelConsumption: 7.0f, ActiveHeatGeneration: 2.20f, Weight: 4, Worth: AdamantTierWorth), EEquipmentType.Thruster, 9);
        }

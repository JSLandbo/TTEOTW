...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Engines.Scrap, "ScrapEngine", LoadSingleTexture(manager, "Player/Engines/ScrapEngine"), new Engine(ID: GameIds.Items.Engines.Scrap, Speed: 400, Acceleration: 100, Name: "Scrap Engine", StandbyFuelConsumption: 0.001f, ActiveFuelConsumption: 0.01f, Worth: ScrapTierWorth, Weight: 5), EEquipmentType.Engine, 0);
            AddEquipmentDefinition(GameIds.Items.Engines.Copper, "CopperEngine", LoadSingleTexture(manager, "Player/Engines/CopperEngine"), new Engine(ID: GameIds.Items.Engines.Copper, Speed: 600, Acceleration: 150, Name: "Copper Engine", StandbyFuelConsumption: 0.02f, ActiveFuelConsumption: 0.2f, Worth: CopperTierWorth, Weight: 6), EEquipmentType.Engine, 1);
            AddEquipmentDefinition(GameIds.Items.Engines.Iron, "IronEngine", LoadSingleTexture(manager, "Player/Engines/IronEngine"), new Engine(ID: GameIds.Items.Engines.Iron, Speed: 900, Acceleration: 250, Name: "Iron Engine", StandbyFuelConsumption: 0.06f, ActiveFuelConsumption: 0.6f, Worth: IronTierWorth, Weight: 7), EEquipmentType.Engine, 2);
            AddEquipmentDefinition(GameIds.Items.Engines.Gold, "GoldEngine", LoadSingleTexture(manager, "Player/Engines/GoldEngine"), new Engine(ID: GameIds.Items.Engines.Gold, Speed: 1450, Acceleration: 400, Name: "Gold Engine", StandbyFuelConsumption: 0.07f, ActiveFuelConsumption: 0.7f, Worth: GoldTierWorth, Weight: 8), EEquipmentType.Engine, 3);
            AddEquipmentDefinition(GameIds.Items.Engines.Crystal, "CrystalEngine", LoadSingleTexture(manager, "Player/Engines/CrystalEngine"), new Engine(ID: GameIds.Items.Engines.Crystal, Speed: 2600, Acceleration: 600, Name: "Crystal Engine", StandbyFuelConsumption: 0.058f, ActiveFuelConsumption: 0.58f, Worth: CrystalTierWorth, Weight: 8), EEquipmentType.Engine, 4);
            AddEquipmentDefinition(GameIds.Items.Engines.Diamond, "DiamondEngine", LoadSingleTexture(manager, "Player/Engines/DiamondEngine"), new Engine(ID: GameIds.Items.Engines.Diamond, Speed: 4800, Acceleration: 1200, Name: "Diamond Engine", StandbyFuelConsumption: 0.046f, ActiveFuelConsumption: 0.46f, Worth: DiamondTierWorth, Weight: 7), EEquipmentType.Engine, 5);
            AddEquipmentDefinition(GameIds.Items.Engines.Radioactive, "RadioactiveEngine", LoadSingleTexture(manager, "Player/Engines/RadioactiveEngine"), new Engine(ID: GameIds.Items.Engines.Radioactive, Speed: 7000, Acceleration: 2500, Name: "Radioactive Engine", StandbyFuelConsumption: 0.034f, ActiveFuelConsumption: 0.34f, Worth: RadioactiveTierWorth, Weight: 6), EEquipmentType.Engine, 6);
            AddEquipmentDefinition(GameIds.Items.Engines.Rainbow, "RainbowEngine", LoadSingleTexture(manager, "Player/Engines/RainbowEngine"), new Engine(ID: GameIds.Items.Engines.Rainbow, Speed: 10000, Acceleration: 5000, Name: "Rainbow Engine", StandbyFuelConsumption: 0.024f, ActiveFuelConsumption: 0.24f, Worth: RainbowTierWorth, Weight: 5), EEquipmentType.Engine, 7);
            AddEquipmentDefinition(GameIds.Items.Engines.Mythril, "MythrilEngine", LoadSingleTexture(manager, "Player/Engines/MythrilEngine"), new Engine(ID: GameIds.Items.Engines.Mythril, Speed: 24000, Acceleration: 7500, Name: "Mythril Engine", StandbyFuelConsumption: 0.018f, ActiveFuelConsumption: 0.18f, Worth: MythrilTierWorth, Weight: 4), EEquipmentType.Engine, 8);
            AddEquipmentDefinition(GameIds.Items.Engines.Adamant, "AdamantEngine", LoadSingleTexture(manager, "Player/Engines/AdamantEngine"), new Engine(ID: GameIds.Items.Engines.Adamant, Speed: 36000, Acceleration: 10000, Name: "Adamant Engine", StandbyFuelConsumption: 0.012f, ActiveFuelConsumption: 0.12f, Worth: AdamantTierWorth, Weight: 4), EEquipmentType.Engine, 9);
        }
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Thrusters.Scrap, "ScrapThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: GameIds.Items.Thrusters.Scrap, Speed: 500f, Acceleration: 30f, Power: 50, Name: "Scrap Thruster", ActiveFuelConsumption: 0.01f, ActiveHeatGeneration: 0.10f, Weight: 5, Worth: ScrapTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 0);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Copper, "CopperThruster", LoadSingleTexture(manager, "Player/Thrusters/CopperThruster"), new Thruster(ID: GameIds.Items.Thrusters.Copper, Speed: 1100f, Acceleration: 60f, Power: 75, Name: "Copper Thruster", ActiveFuelConsumption: 0.3f, ActiveHeatGeneration: 0.18f, Weight: 6, Worth: CopperTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 1);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Iron, "IronThruster", LoadSingleTexture(manager, "Player/Thrusters/IronThruster"), new Thruster(ID: GameIds.Items.Thrusters.Iron, Speed: 2000f, Acceleration: 120f, Power: 110, Name: "Iron Thruster", ActiveFuelConsumption: 2.0f, ActiveHeatGeneration: 0.28f, Weight: 7, Worth: IronTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 2);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Gold, "GoldThruster", LoadSingleTexture(manager, "Player/Thrusters/GoldThruster"), new Thruster(ID: GameIds.Items.Thrusters.Gold, Speed: 4000f, Acceleration: 240f, Power: 160, Name: "Gold Thruster", ActiveFuelConsumption: 2.9f, ActiveHeatGeneration: 0.40f, Weight: 8, Worth: GoldTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 3);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Crystal, "CrystalThruster", LoadSingleTexture(manager, "Player/Thrusters/CrystalThruster"), new Thruster(ID: GameIds.Items.Thrusters.Crystal, Speed: 8000f, Acceleration: 480f, Power: 230, Name: "Crystal Thruster", ActiveFuelConsumption: 3.4f, ActiveHeatGeneration: 0.55f, Weight: 8, Worth: CrystalTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 4);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Diamond, "DiamondThruster", LoadSingleTexture(manager, "Player/Thrusters/DiamondThruster"), new Thruster(ID: GameIds.Items.Thrusters.Diamond, Speed: 24000f, Acceleration: 960f, Power: 320, Name: "Diamond Thruster", ActiveFuelConsumption: 4.0f, ActiveHeatGeneration: 0.75f, Weight: 7, Worth: DiamondTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 5);
            ...
            AddEquipmentDefinition(GameIds.Items.Thrusters.Rainbow, "RainbowThruster", LoadSingleTexture(manager, "Player/Thrusters/RainbowThruster"), new Thruster(ID: GameIds.Items.Thrusters.Rainbow, Speed: 48000f, Acceleration: 3840f, Power: 1500, Name: "Rainbow Thruster", ActiveFuelConsumption: 5.5f, ActiveHeatGeneration: 1.35f, Weight: 5, Worth: RainbowTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 7);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Mythril, "MythrilThruster", LoadSingleTexture(manager, "Player/Thrusters/MythrilThruster"), new Thruster(ID: GameIds.Items.Thrusters.Mythril, Speed: 96000f, Acceleration: 7680f, Power: 2200, Name: "Mythril Thruster", ActiveFuelConsumption: 6.2f, ActiveHeatGeneration: 1.75f, Weight: 4, Worth: MythrilTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 8);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Adamant, "AdamantThruster", LoadSingleTexture(manager, "Player/Thrusters/AdamantThruster"), new Thruster(ID: GameIds.Items.Thrusters.Adamant, Speed: 192000f, Acceleration: 15360f, Power: 3200, Name: "Adamant Thruster", ActiveFuelConsumption: 7.0f, ActiveHeatGeneration: 2.20f, Weight: 4, Worth: AdamantTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 9);
        }

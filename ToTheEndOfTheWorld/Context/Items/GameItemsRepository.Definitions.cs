...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Containers.Scrap, "Scrap Container", LoadSingleTexture(manager, "Player/Containers/ScrapContainer"), new Inventory(ID: GameIds.Items.Containers.Scrap, Items: CreateInventoryGrid(3, 1), Name: "Scrap Container", Worth: ScrapTierWorth, Weight: 5, MaxStackSize: 8), EEquipmentType.Inventory, 0);
            AddEquipmentDefinition(GameIds.Items.Containers.Copper, "Copper Container", LoadSingleTexture(manager, "Player/Containers/CopperContainer"), new Inventory(ID: GameIds.Items.Containers.Copper, Items: CreateInventoryGrid(2, 2), Name: "Copper Container", Worth: CopperTierWorth, Weight: 6, MaxStackSize: 16), EEquipmentType.Inventory, 1);
            AddEquipmentDefinition(GameIds.Items.Containers.Iron, "Iron Container", LoadSingleTexture(manager, "Player/Containers/IronContainer"), new Inventory(ID: GameIds.Items.Containers.Iron, Items: CreateInventoryGrid(2, 3), Name: "Iron Container", Worth: IronTierWorth, Weight: 7, MaxStackSize: 32), EEquipmentType.Inventory, 2);
            ...
            AddEquipmentDefinition(GameIds.Items.Containers.Crystal, "Crystal Container", LoadSingleTexture(manager, "Player/Containers/CrystalContainer"), new Inventory(ID: GameIds.Items.Containers.Crystal, Items: CreateInventoryGrid(3, 4), Name: "Crystal Container", Worth: CrystalTierWorth, Weight: 8, MaxStackSize: 64), EEquipmentType.Inventory, 4);
            AddEquipmentDefinition(GameIds.Items.Containers.Diamond, "Diamond Container", LoadSingleTexture(manager, "Player/Containers/DiamondContainer"), new Inventory(ID: GameIds.Items.Containers.Diamond, Items: CreateInventoryGrid(4, 4), Name: "Diamond Container", Worth: DiamondTierWorth, Weight: 7, MaxStackSize: 64), EEquipmentType.Inventory, 5);
            AddEquipmentDefinition(GameIds.Items.Containers.Radioactive, "Radioactive Container", LoadSingleTexture(manager, "Player/Containers/RadioactiveContainer"), new Inventory(ID: GameIds.Items.Containers.Radioactive, Items: CreateInventoryGrid(4, 5), Name: "Radioactive Container", Worth: RadioactiveTierWorth, Weight: 6, MaxStackSize: 64), EEquipmentType.Inventory, 6);
            AddEquipmentDefinition(GameIds.Items.Containers.Rainbow, "Rainbow Container", LoadSingleTexture(manager, "Player/Containers/RainbowContainer"), new Inventory(ID: GameIds.Items.Containers.Rainbow, Items: CreateInventoryGrid(5, 5), Name: "Rainbow Container", Worth: RainbowTierWorth, Weight: 5, MaxStackSize: 64), EEquipmentType.Inventory, 7);
            AddEquipmentDefinition(GameIds.Items.Containers.Mythril, "Mythril Container", LoadSingleTexture(manager, "Player/Containers/MythrilContainer"), new Inventory(ID: GameIds.Items.Containers.Mythril, Items: CreateInventoryGrid(8, 6), Name: "Mythril Container", Worth: MythrilTierWorth, Weight: 4, MaxStackSize: 128), EEquipmentType.Inventory, 8);
            AddEquipmentDefinition(GameIds.Items.Containers.Adamant, "Adamant Container", LoadSingleTexture(manager, "Player/Containers/AdamantContainer"), new Inventory(ID: GameIds.Items.Containers.Adamant, Items: CreateInventoryGrid(10, 8), Name: "Adamant Container", Worth: AdamantTierWorth, Weight: 4, MaxStackSize: 512), EEquipmentType.Inventory, 9);
        }

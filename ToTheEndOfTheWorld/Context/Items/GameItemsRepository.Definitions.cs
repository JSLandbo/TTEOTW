...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        private void RegisterThrusters(ContentManager manager)
        {
            ...
            AddEquipmentDefinition(GameIds.Items.Thrusters.Copper, "CopperThruster", LoadSingleTexture(manager, "Player/Thrusters/CopperThruster"), new Thruster(ID: GameIds.Items.Thrusters.Copper, Speed: 1100f, Acceleration: 100f, Power: 75, Name: "Copper Thruster", ActiveFuelConsumption: 0.1f, ActiveHeatGeneration: 0.18f, Weight: 6, Worth: CopperTierWorth), EEquipmentType.Thruster, 1);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Iron, "IronThruster", LoadSingleTexture(manager, "Player/Thrusters/IronThruster"), new Thruster(ID: GameIds.Items.Thrusters.Iron, Speed: 2000f, Acceleration: 200f, Power: 110, Name: "Iron Thruster", ActiveFuelConsumption: 0.4f, ActiveHeatGeneration: 0.28f, Weight: 7, Worth: IronTierWorth), EEquipmentType.Thruster, 2);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Gold, "GoldThruster", LoadSingleTexture(manager, "Player/Thrusters/GoldThruster"), new Thruster(ID: GameIds.Items.Thrusters.Gold, Speed: 4000f, Acceleration: 300f, Power: 160, Name: "Gold Thruster", ActiveFuelConsumption: 1.2f, ActiveHeatGeneration: 0.40f, Weight: 8, Worth: GoldTierWorth), EEquipmentType.Thruster, 3);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Crystal, "CrystalThruster", LoadSingleTexture(manager, "Player/Thrusters/CrystalThruster"), new Thruster(ID: GameIds.Items.Thrusters.Crystal, Speed: 8000f, Acceleration: 400f, Power: 230, Name: "Crystal Thruster", ActiveFuelConsumption: 2.4f, ActiveHeatGeneration: 0.55f, Weight: 8, Worth: CrystalTierWorth), EEquipmentType.Thruster, 4);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Diamond, "DiamondThruster", LoadSingleTexture(manager, "Player/Thrusters/DiamondThruster"), new Thruster(ID: GameIds.Items.Thrusters.Diamond, Speed: 24000f, Acceleration: 800f, Power: 320, Name: "Diamond Thruster", ActiveFuelConsumption: 3.6f, ActiveHeatGeneration: 0.75f, Weight: 7, Worth: DiamondTierWorth), EEquipmentType.Thruster, 5);

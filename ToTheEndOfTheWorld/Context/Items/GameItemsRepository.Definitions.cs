...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        private void RegisterThrusters(ContentManager manager)
        {
            ...
            AddEquipmentDefinition(GameIds.Items.Thrusters.Radioactive, "RadioactiveThruster", LoadSingleTexture(manager, "Player/Thrusters/RadioactiveThruster"), new Thruster(ID: GameIds.Items.Thrusters.Radioactive, Speed: 15360f, Acceleration: 1200f, Power: 1250, Name: "Radioactive Thruster", ActiveFuelConsumption: 4.7f, ActiveHeatGeneration: 1.00f, Weight: 6, Worth: RadioactiveTierWorth), EEquipmentType.Thruster, 6);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Rainbow, "RainbowThruster", LoadSingleTexture(manager, "Player/Thrusters/RainbowThruster"), new Thruster(ID: GameIds.Items.Thrusters.Rainbow, Speed: 48000f, Acceleration: 1750f, Power: 2500, Name: "Rainbow Thruster", ActiveFuelConsumption: 5.5f, ActiveHeatGeneration: 1.35f, Weight: 5, Worth: RainbowTierWorth), EEquipmentType.Thruster, 7);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Mythril, "MythrilThruster", LoadSingleTexture(manager, "Player/Thrusters/MythrilThruster"), new Thruster(ID: GameIds.Items.Thrusters.Mythril, Speed: 96000f, Acceleration: 2500f, Power: 7500, Name: "Mythril Thruster", ActiveFuelConsumption: 6.2f, ActiveHeatGeneration: 1.75f, Weight: 4, Worth: MythrilTierWorth), EEquipmentType.Thruster, 8);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Adamant, "AdamantThruster", LoadSingleTexture(manager, "Player/Thrusters/AdamantThruster"), new Thruster(ID: GameIds.Items.Thrusters.Adamant, Speed: 192000f, Acceleration: 4000f, Power: 15000, Name: "Adamant Thruster", ActiveFuelConsumption: 7.0f, ActiveHeatGeneration: 2.20f, Weight: 4, Worth: AdamantTierWorth), EEquipmentType.Thruster, 9);
        }
        ...
        private void RegisterDrills(ContentManager manager)
        {
            ...
            AddEquipmentDefinition(GameIds.Items.Drills.Rainbow, "RainbowDrill", LoadDrillTextures(manager, "Player/Drills/RainbowDrill/RainbowDrill"), new Drill(ID: GameIds.Items.Drills.Rainbow, Hardness: 2000f, Damage: 200.0f, Name: "Rainbow Drill", Worth: RainbowTierWorth, Weight: 5, MiningAreaSize: 1, ActiveFuelConsumption: 0.24f), EEquipmentType.Drill, 7);
            AddEquipmentDefinition(GameIds.Items.Drills.Mythril, "MythrilDrill", LoadDrillTextures(manager, "Player/Drills/MythrilDrill/MythrilDrill"), new Drill(ID: GameIds.Items.Drills.Mythril, Hardness: 4000f, Damage: 400.0f, Name: "Mythril Drill", Worth: MythrilTierWorth, Weight: 4, MiningAreaSize: 3, ActiveFuelConsumption: 0.18f), EEquipmentType.Drill, 8);
            AddEquipmentDefinition(GameIds.Items.Drills.Adamant, "AdamantDrill", LoadDrillTextures(manager, "Player/Drills/AdamantDrill/AdamantDrill"), new Drill(ID: GameIds.Items.Drills.Adamant, Hardness: 10000f, Damage: 500.0f, Name: "Adamant Drill", Worth: AdamantTierWorth, Weight: 4, MiningAreaSize: 9, ActiveFuelConsumption: 0.12f), EEquipmentType.Drill, 9);
        }

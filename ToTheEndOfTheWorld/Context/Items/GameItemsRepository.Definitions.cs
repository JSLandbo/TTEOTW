...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Thrusters.Scrap, "ScrapThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: GameIds.Items.Thrusters.Scrap, Speed: 500f, Acceleration: 50f, Power: 50, Name: "Scrap Thruster", ActiveFuelConsumption: 0.05f, ActiveHeatGeneration: 0.10f, Weight: 5, Worth: ScrapTierWorth), EEquipmentType.Thruster, 0);
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Drills.Scrap, "ScrapDrill", LoadDrillTextures(manager, "Player/Drills/DirtDrill/DirtDrill"), new Drill(ID: GameIds.Items.Drills.Scrap, Hardness: 5f, Damage: 0.1f, Name: "Scrap Drill", Worth: ScrapTierWorth, Weight: 5, MiningAreaSize: 1, ActiveFuelConsumption: 0.1f), EEquipmentType.Drill, 0);
            AddEquipmentDefinition(GameIds.Items.Drills.Copper, "CopperDrill", LoadDrillTextures(manager, "Player/Drills/CopperDrill/CopperDrill"), new Drill(ID: GameIds.Items.Drills.Copper, Hardness: 15f, Damage: 0.25f, Name: "Copper Drill", Worth: CopperTierWorth, Weight: 6, MiningAreaSize: 1, ActiveFuelConsumption: 0.2f), EEquipmentType.Drill, 1);
            ...
            AddEquipmentDefinition(GameIds.Items.Drills.Gold, "GoldDrill", LoadDrillTextures(manager, "Player/Drills/GoldDrill/GoldDrill"), new Drill(ID: GameIds.Items.Drills.Gold, Hardness: 80f, Damage: 3.0f, Name: "Gold Drill", Worth: GoldTierWorth, Weight: 8, MiningAreaSize: 1, ActiveFuelConsumption: 0.7f), EEquipmentType.Drill, 3);
            AddEquipmentDefinition(GameIds.Items.Drills.Crystal, "CrystalDrill", LoadDrillTextures(manager, "Player/Drills/CrystalDrill/CrystalDrill"), new Drill(ID: GameIds.Items.Drills.Crystal, Hardness: 180f, Damage: 6.5f, Name: "Crystal Drill", Worth: CrystalTierWorth, Weight: 8, MiningAreaSize: 1, ActiveFuelConsumption: 0.58f), EEquipmentType.Drill, 4);
            AddEquipmentDefinition(GameIds.Items.Drills.Diamond, "DiamondDrill", LoadDrillTextures(manager, "Player/Drills/DiamondDrill/DiamondDrill"), new Drill(ID: GameIds.Items.Drills.Diamond, Hardness: 400f, Damage: 15.0f, Name: "Diamond Drill", Worth: DiamondTierWorth, Weight: 7, MiningAreaSize: 1, ActiveFuelConsumption: 0.46f), EEquipmentType.Drill, 5);
            AddEquipmentDefinition(GameIds.Items.Drills.Radioactive, "RadioactiveDrill", LoadDrillTextures(manager, "Player/Drills/RadioactiveDrill/RadioactiveDrill"), new Drill(ID: GameIds.Items.Drills.Radioactive, Hardness: 900f, Damage: 80.0f, Name: "Radioactive Drill", Worth: RadioactiveTierWorth, Weight: 6, MiningAreaSize: 1, ActiveFuelConsumption: 0.34f), EEquipmentType.Drill, 6);

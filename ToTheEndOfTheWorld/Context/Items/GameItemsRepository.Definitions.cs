...
namespace ToTheEndOfTheWorld.Context.Items
{
    public sealed partial class GameItemsRepository
    {
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Engines.Scrap, "ScrapEngine", LoadSingleTexture(manager, "Player/Engines/ScrapEngine"), new Engine(ID: GameIds.Items.Engines.Scrap, Speed: 2, Name: "Scrap Engine", ActiveFuelConsumption: 1.0f, Worth: ScrapTierWorth, Weight: 5), EEquipmentType.Engine, 0);
            AddEquipmentDefinition(GameIds.Items.Engines.Copper, "CopperEngine", LoadSingleTexture(manager, "Player/Engines/CopperEngine"), new Engine(ID: GameIds.Items.Engines.Copper, Speed: 4, Name: "Copper Engine", ActiveFuelConsumption: 0.92f, Worth: CopperTierWorth, Weight: 6), EEquipmentType.Engine, 1);
            AddEquipmentDefinition(GameIds.Items.Engines.Iron, "IronEngine", LoadSingleTexture(manager, "Player/Engines/IronEngine"), new Engine(ID: GameIds.Items.Engines.Iron, Speed: 6, Name: "Iron Engine", ActiveFuelConsumption: 0.82f, Worth: IronTierWorth, Weight: 7), EEquipmentType.Engine, 2);
            AddEquipmentDefinition(GameIds.Items.Engines.Gold, "GoldEngine", LoadSingleTexture(manager, "Player/Engines/GoldEngine"), new Engine(ID: GameIds.Items.Engines.Gold, Speed: 20, Name: "Gold Engine", ActiveFuelConsumption: 0.7f, Worth: GoldTierWorth, Weight: 8), EEquipmentType.Engine, 3);
            AddEquipmentDefinition(GameIds.Items.Engines.Crystal, "CrystalEngine", LoadSingleTexture(manager, "Player/Engines/CrystalEngine"), new Engine(ID: GameIds.Items.Engines.Crystal, Speed: 40, Name: "Crystal Engine", ActiveFuelConsumption: 0.58f, Worth: CrystalTierWorth, Weight: 8), EEquipmentType.Engine, 4);
            AddEquipmentDefinition(GameIds.Items.Engines.Diamond, "DiamondEngine", LoadSingleTexture(manager, "Player/Engines/DiamondEngine"), new Engine(ID: GameIds.Items.Engines.Diamond, Speed: 80, Name: "Diamond Engine", ActiveFuelConsumption: 0.46f, Worth: DiamondTierWorth, Weight: 7), EEquipmentType.Engine, 5);
            AddEquipmentDefinition(GameIds.Items.Engines.Radioactive, "RadioactiveEngine", LoadSingleTexture(manager, "Player/Engines/RadioactiveEngine"), new Engine(ID: GameIds.Items.Engines.Radioactive, Speed: 160, Name: "Radioactive Engine", ActiveFuelConsumption: 0.34f, Worth: RadioactiveTierWorth, Weight: 6), EEquipmentType.Engine, 6);
            AddEquipmentDefinition(GameIds.Items.Engines.Rainbow, "RainbowEngine", LoadSingleTexture(manager, "Player/Engines/RainbowEngine"), new Engine(ID: GameIds.Items.Engines.Rainbow, Speed: 320, Name: "Rainbow Engine", ActiveFuelConsumption: 0.24f, Worth: RainbowTierWorth, Weight: 5), EEquipmentType.Engine, 7);
            AddEquipmentDefinition(GameIds.Items.Engines.Mythril, "MythrilEngine", LoadSingleTexture(manager, "Player/Engines/MythrilEngine"), new Engine(ID: GameIds.Items.Engines.Mythril, Speed: 640, Name: "Mythril Engine", ActiveFuelConsumption: 0.18f, Worth: MythrilTierWorth, Weight: 4), EEquipmentType.Engine, 8);
            AddEquipmentDefinition(GameIds.Items.Engines.Adamant, "AdamantEngine", LoadSingleTexture(manager, "Player/Engines/AdamantEngine"), new Engine(ID: GameIds.Items.Engines.Adamant, Speed: 1200, Name: "Adamant Engine", ActiveFuelConsumption: 0.12f, Worth: AdamantTierWorth, Weight: 4), EEquipmentType.Engine, 9);
        }

        private void RegisterFuelTanks(ContentManager manager)
        {
            AddEquipmentDefinition(GameIds.Items.FuelTanks.Scrap, "ScrapFuelTank", LoadSingleTexture(manager, "Player/FuelTanks/ScrapFuelTank"), new FuelTank(ID: GameIds.Items.FuelTanks.Scrap, Capacity: 200, Fuel: 200, Name: "Scrap Fuel Tank", Worth: ScrapTierWorth, Weight: 5), EEquipmentType.FuelTank, 0);
            AddEquipmentDefinition(GameIds.Items.FuelTanks.Copper, "CopperFuelTank", LoadSingleTexture(manager, "Player/FuelTanks/CopperFuelTank"), new FuelTank(ID: GameIds.Items.FuelTanks.Copper, Capacity: 350, Fuel: 350, Name: "Copper Fuel Tank", Worth: CopperTierWorth, Weight: 6), EEquipmentType.FuelTank, 1);
            AddEquipmentDefinition(GameIds.Items.FuelTanks.Iron, "IronFuelTank", LoadSingleTexture(manager, "Player/FuelTanks/IronFuelTank"), new FuelTank(ID: GameIds.Items.FuelTanks.Iron, Capacity: 550, Fuel: 550, Name: "Iron Fuel Tank", Worth: IronTierWorth, Weight: 7), EEquipmentType.FuelTank, 2);
            AddEquipmentDefinition(GameIds.Items.FuelTanks.Gold, "GoldFuelTank", LoadSingleTexture(manager, "Player/FuelTanks/GoldFuelTank"), new FuelTank(ID: GameIds.Items.FuelTanks.Gold, Capacity: 850, Fuel: 850, Name: "Gold Fuel Tank", Worth: GoldTierWorth, Weight: 8), EEquipmentType.FuelTank, 3);
            AddEquipmentDefinition(GameIds.Items.FuelTanks.Crystal, "CrystalFuelTank", LoadSingleTexture(manager, "Player/FuelTanks/CrystalFuelTank"), new FuelTank(ID: GameIds.Items.FuelTanks.Crystal, Capacity: 1300, Fuel: 1300, Name: "Crystal Fuel Tank", Worth: CrystalTierWorth, Weight: 8), EEquipmentType.FuelTank, 4);
            AddEquipmentDefinition(GameIds.Items.FuelTanks.Diamond, "DiamondFuelTank", LoadSingleTexture(manager, "Player/FuelTanks/DiamondFuelTank"), new FuelTank(ID: GameIds.Items.FuelTanks.Diamond, Capacity: 1900, Fuel: 1900, Name: "Diamond Fuel Tank", Worth: DiamondTierWorth, Weight: 7), EEquipmentType.FuelTank, 5);
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Thrusters.Scrap, "ScrapThruster", LoadSingleTexture(manager, "Player/Thrusters/ScrapThruster"), new Thruster(ID: GameIds.Items.Thrusters.Scrap, Speed: 240f, Acceleration: 30f, Power: 50, Name: "Scrap Thruster", ActiveFuelConsumption: 2.0f, Weight: 5, Worth: ScrapTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 0);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Copper, "CopperThruster", LoadSingleTexture(manager, "Player/Thrusters/CopperThruster"), new Thruster(ID: GameIds.Items.Thrusters.Copper, Speed: 480f, Acceleration: 60f, Power: 75, Name: "Copper Thruster", ActiveFuelConsumption: 2.2f, Weight: 6, Worth: CopperTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 1);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Iron, "IronThruster", LoadSingleTexture(manager, "Player/Thrusters/IronThruster"), new Thruster(ID: GameIds.Items.Thrusters.Iron, Speed: 960f, Acceleration: 120f, Power: 110, Name: "Iron Thruster", ActiveFuelConsumption: 2.5f, Weight: 7, Worth: IronTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 2);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Gold, "GoldThruster", LoadSingleTexture(manager, "Player/Thrusters/GoldThruster"), new Thruster(ID: GameIds.Items.Thrusters.Gold, Speed: 1920f, Acceleration: 240f, Power: 160, Name: "Gold Thruster", ActiveFuelConsumption: 2.9f, Weight: 8, Worth: GoldTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 3);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Crystal, "CrystalThruster", LoadSingleTexture(manager, "Player/Thrusters/CrystalThruster"), new Thruster(ID: GameIds.Items.Thrusters.Crystal, Speed: 3840f, Acceleration: 480f, Power: 230, Name: "Crystal Thruster", ActiveFuelConsumption: 3.4f, Weight: 8, Worth: CrystalTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 4);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Diamond, "DiamondThruster", LoadSingleTexture(manager, "Player/Thrusters/DiamondThruster"), new Thruster(ID: GameIds.Items.Thrusters.Diamond, Speed: 7680f, Acceleration: 960f, Power: 320, Name: "Diamond Thruster", ActiveFuelConsumption: 4.0f, Weight: 7, Worth: DiamondTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 5);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Radioactive, "RadioactiveThruster", LoadSingleTexture(manager, "Player/Thrusters/RadioactiveThruster"), new Thruster(ID: GameIds.Items.Thrusters.Radioactive, Speed: 15360f, Acceleration: 1920f, Power: 440, Name: "Radioactive Thruster", ActiveFuelConsumption: 4.7f, Weight: 6, Worth: RadioactiveTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 6);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Rainbow, "RainbowThruster", LoadSingleTexture(manager, "Player/Thrusters/RainbowThruster"), new Thruster(ID: GameIds.Items.Thrusters.Rainbow, Speed: 30720f, Acceleration: 3840f, Power: 1500, Name: "Rainbow Thruster", ActiveFuelConsumption: 5.5f, Weight: 5, Worth: RainbowTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 7);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Mythril, "MythrilThruster", LoadSingleTexture(manager, "Player/Thrusters/MythrilThruster"), new Thruster(ID: GameIds.Items.Thrusters.Mythril, Speed: 61440f, Acceleration: 7680f, Power: 2200, Name: "Mythril Thruster", ActiveFuelConsumption: 6.2f, Weight: 4, Worth: MythrilTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 8);
            AddEquipmentDefinition(GameIds.Items.Thrusters.Adamant, "AdamantThruster", LoadSingleTexture(manager, "Player/Thrusters/AdamantThruster"), new Thruster(ID: GameIds.Items.Thrusters.Adamant, Speed: 122880f, Acceleration: 15360f, Power: 3200, Name: "Adamant Thruster", ActiveFuelConsumption: 7.0f, Weight: 4, Worth: AdamantTierWorth, MinimumVelocity: 10f), EEquipmentType.Thruster, 9);
        }
        ...
        {
            AddEquipmentDefinition(GameIds.Items.Drills.Scrap, "ScrapDrill", LoadDrillTextures(manager, "Player/Drills/DirtDrill/DirtDrill"), new Drill(ID: GameIds.Items.Drills.Scrap, Hardness: 5f, Damage: 0.1f, Name: "Scrap Drill", Worth: ScrapTierWorth, Weight: 5, MiningAreaSize: 1), EEquipmentType.Drill, 0);
            AddEquipmentDefinition(GameIds.Items.Drills.Copper, "CopperDrill", LoadDrillTextures(manager, "Player/Drills/CopperDrill/CopperDrill"), new Drill(ID: GameIds.Items.Drills.Copper, Hardness: 15f, Damage: 0.25f, Name: "Copper Drill", Worth: CopperTierWorth, Weight: 6, MiningAreaSize: 1), EEquipmentType.Drill, 1);
            AddEquipmentDefinition(GameIds.Items.Drills.Iron, "IronDrill", LoadDrillTextures(manager, "Player/Drills/IronDrill/IronDrill"), new Drill(ID: GameIds.Items.Drills.Iron, Hardness: 35f, Damage: 1.2f, Name: "Iron Drill", Worth: IronTierWorth, Weight: 7, MiningAreaSize: 1), EEquipmentType.Drill, 2);
            AddEquipmentDefinition(GameIds.Items.Drills.Gold, "GoldDrill", LoadDrillTextures(manager, "Player/Drills/GoldDrill/GoldDrill"), new Drill(ID: GameIds.Items.Drills.Gold, Hardness: 80f, Damage: 3.0f, Name: "Gold Drill", Worth: GoldTierWorth, Weight: 8, MiningAreaSize: 1), EEquipmentType.Drill, 3);
            AddEquipmentDefinition(GameIds.Items.Drills.Crystal, "CrystalDrill", LoadDrillTextures(manager, "Player/Drills/CrystalDrill/CrystalDrill"), new Drill(ID: GameIds.Items.Drills.Crystal, Hardness: 180f, Damage: 6.5f, Name: "Crystal Drill", Worth: CrystalTierWorth, Weight: 8, MiningAreaSize: 1), EEquipmentType.Drill, 4);
            AddEquipmentDefinition(GameIds.Items.Drills.Diamond, "DiamondDrill", LoadDrillTextures(manager, "Player/Drills/DiamondDrill/DiamondDrill"), new Drill(ID: GameIds.Items.Drills.Diamond, Hardness: 400f, Damage: 15.0f, Name: "Diamond Drill", Worth: DiamondTierWorth, Weight: 7, MiningAreaSize: 1), EEquipmentType.Drill, 5);
            AddEquipmentDefinition(GameIds.Items.Drills.Radioactive, "RadioactiveDrill", LoadDrillTextures(manager, "Player/Drills/RadioactiveDrill/RadioactiveDrill"), new Drill(ID: GameIds.Items.Drills.Radioactive, Hardness: 900f, Damage: 80.0f, Name: "Radioactive Drill", Worth: RadioactiveTierWorth, Weight: 6, MiningAreaSize: 1), EEquipmentType.Drill, 6);
            AddEquipmentDefinition(GameIds.Items.Drills.Rainbow, "RainbowDrill", LoadDrillTextures(manager, "Player/Drills/RainbowDrill/RainbowDrill"), new Drill(ID: GameIds.Items.Drills.Rainbow, Hardness: 2000f, Damage: 400.0f, Name: "Rainbow Drill", Worth: RainbowTierWorth, Weight: 5, MiningAreaSize: 1), EEquipmentType.Drill, 7);
            AddEquipmentDefinition(GameIds.Items.Drills.Mythril, "MythrilDrill", LoadDrillTextures(manager, "Player/Drills/MythrilDrill/MythrilDrill"), new Drill(ID: GameIds.Items.Drills.Mythril, Hardness: 4000f, Damage: 1500.0f, Name: "Mythril Drill", Worth: MythrilTierWorth, Weight: 4, MiningAreaSize: 3), EEquipmentType.Drill, 8);
            AddEquipmentDefinition(GameIds.Items.Drills.Adamant, "AdamantDrill", LoadDrillTextures(manager, "Player/Drills/AdamantDrill/AdamantDrill"), new Drill(ID: GameIds.Items.Drills.Adamant, Hardness: 10000f, Damage: 8000.0f, Name: "Adamant Drill", Worth: AdamantTierWorth, Weight: 4, MiningAreaSize: 9), EEquipmentType.Drill, 9);
        }
